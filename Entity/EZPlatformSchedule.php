...
namespace CampaignChain\Operation\EZPlatformBundle\Entity;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="campaignchain_operation_ezplatform_schedule")
 */
class EZPlatformSchedule extends Meta
{
    /**
